...
A synthetic maritime domain awareness (MDA) dashboard for the Grand Banks off Newfoundland. No backend — a client-side simulation clock drives ~100 synthetic AIS contacts across a live MapLibre map.
...
- ~100 synthetic vessels (realistic MMSIs, names, ship types) scattered across the Grand Banks (42–52N, 46–60W), kept off land by a coastline mask
